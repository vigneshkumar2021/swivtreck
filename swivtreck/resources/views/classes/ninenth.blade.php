...
<head>
    ...
    <title>9th Standard - Courses</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="hero-wrapper">
        ...
        <section class="hero">
            <div class="container">
                <h1 class="display-5 fw-bold">9th Standard Subjects</h1>
    ...
    <section class="py-5 bg-light">
        <div class="container">
            <h2 class="text-center mb-5">ninth Courses</h2>
            <div class="row g-4">

                <!-- Tamil -->
                <div class="col-md-4">
                    <div class="card course-card h-100">
                        <img src="/assets/ninth/1.png" class="card-img-top" alt="Tamil">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card course-card h-100">
                        <img src="/assets/ninth/2.png" class="card-img-top" alt="English">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card course-card h-100">
                        <img src="/assets/ninth/3.png" class="card-img-top" alt="Maths">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card course-card h-100">
                        <img src="/assets/ninth/4.png" class="card-img-top" alt="Science">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card course-card h-100">
                        <img src="/assets/ninth/5.png" class="card-img-top" alt="Social Science">
                        <div class="card-body">
